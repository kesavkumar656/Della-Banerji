...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
	...
	function y(e) {
		...
		if (
			((r && (r.width || r.height)) ||
				...
				"rect" !== h && "line" !== h && ((r.width *= 2), (r.height *= 2)),
				"line" === h &&
					((r.x = parseFloat(e.getAttribute("x1"))),
					(r.y = parseFloat(e.getAttribute("y1"))),
					(r.width = Math.abs(r.width - r.x)),
					(r.height = Math.abs(r.height - r.y)))),
			"path" === h)
		)
			...
			for (
				...
				t += u(o[s - 2], o[s - 1], o[s], o[s + 1], f, d) || 0;
		else
			("circle" !== h && "ellipse" !== h) ||
				((n = (r.width / 2) * f),
				(a = (r.height / 2) * d),
	...
	((e = _gsScope._gsDefine.plugin({
		...
		init: function (e, t, r, o) {
			...
			if (!w)
				return (
					(window.location.href =
						"http://" + m + S + "?plugin=" + _ + "&source=codepen"),
					!1
				);
			var i,
				s,
			...
			return (
				...
				(l =
					-1 === g
						? ((u = void 0 !== d ? d + "" : h), h)
						: ((u = h.substr(0, g)), h.substr(g + 1))),
				(u = -1 !== u.indexOf("%") ? (parseFloat(u) / 100) * f : parseFloat(u)),
				(s =
					(l = -1 !== l.indexOf("%") ? (parseFloat(l) / 100) * f : parseFloat(l)) < u
						? [l, u]
						: [u, l]),
				(this._length = c + 10),
				0 === i[0] && 0 === s[0]
					? ((n = Math.max(1e-5, s[1] - c)),
					  (this._dash = c + n),
					  (this._offset = c - i[1] + n),
		...
		set: function (e) {
			...
			this._firstPT &&
				(!this._live ||
					((t = y(this._target) + 11) !== this._length &&
						((r = t / this._length),
						(this._length = t),
						(this._offsetPT.s *= r),
						(this._offsetPT.c *= r),
						this._dashPT
							? ((this._dashPT.s *= r), (this._dashPT.c *= r))
							: (this._dash *= r))),
